...
# Handover state: DoF 1 =  0.4, DoF3 = Full_in
# Dropoff state: DoF 1 =  -0.8, DoF3 = Full_out

class reg_hrc2d_closed_loop_predictions:
    def __init__(self):
    ...
    def data_prepare(self):
        ...
        if self.data_log_flag == 1:
            ...
            Y_current = [2 - (self.trial_number % 2), self.trial_number] # Update with target clustering part later on
            ...
            if self.trial_number > self.jump_init_number: #and self.set_target == 0:
            ...
            # JumpsMethod for target clustering:
    ...
    def reprocess_Yn(self):
        ...
        for i in range(0, int(self.trial_number)):
            ind = np.where(int(self.Ynt[:, 1]) == i+1)[0]
...
if __name__ == '__main__':
    t1 = reg_hrc2d_closed_loop_predictions()
    t1.run()
