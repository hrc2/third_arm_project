...
fig1 = plt.figure()
fig1.suptitle('Moment loads for Fetching',fontsize=16)
ax1 = fig1.add_subplot(111)
l1 = ax1.plot(shoulder_moments,label='Shoulder',linewidth=2.0, c='r')
l2 = ax1.plot(elbow_moments,label='Elbow',linewidth=2.0, c='b')
ax1.set_ylim([0,20])
